// $HeadURL: http://forge-urd44.osn.sagem/svn/sc.stb-lib-opal/BO/branches/BO_sc.stb-lib-opal/scripts/kconfig/qconf.cc $
// $Id: qconf.cc 2416 2011-03-09 11:23:02Z g178508 $
	...
	: searchWindow(0)
{
	...
	snprintf(title, sizeof(title), CONFIG_PROJNAME" Configuration");
	setCaption(title);
...
int main(int ac, char** av)
{
   ...
   /* Parser Kconfig from its location */
	...
	configSettings->beginGroup("/scripts/kconfig/qconf");
