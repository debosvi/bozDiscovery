// $HeadURL: http://forge-urd44.osn.sagem/svn/sc.stb-lib-opal/BO/branches/BO_sc.stb-lib-opal/scripts/kconfig/confdata.c $
// $Id: confdata.c 2416 2011-03-09 11:23:02Z g178508 $
...
load:
    ...
    while (fgets(line, sizeof(line), in)) {
        ...
        case '\n':
            break;
        default:
            if (memcmp(line, "AUTOCONF_", 9)) {
                conf_warning("unexpected data (default)");
                continue;
            }
        }
