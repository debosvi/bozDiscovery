// $HeadURL: http://forge-urd44.osn.sagem/svn/sc.stb-lib-opal/BO/branches/BO_sc.stb-lib-opal/scripts/kconfig/util.c $
// $Id: util.c 2416 2011-03-09 11:23:02Z g178508 $
...
static int write_make_deps(const char *name)
{
	...
	fprintf(out, "# ATTENTION! This does not handle 'depends', just 'select'! \n"
		"# See scripts/kconfig/util.c write_make_deps()\n#\n");
...
next:
	...
	printf(_("#\n"
		 ...
		 "# ATTENTION "CONFIG_PROJNAME" devels!\n"
