...
#include "skarnet/buffer.h"
#include "skarnet/stralloc.h"
#include "skarnet/genalloc.h"
...
int main (void)
{
...

  {
    ...
    if (!skaserver2_sync(&asyncout, BOZDISCO_BANNER1, BOZDISCO_BANNER1_LEN, BOZDISCO_BANNER2, BOZDISCO_BANNER2_LEN, &deadline, &stamp))
